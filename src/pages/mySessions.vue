<template>
    <v-container>
        ...
        <div class="mt-10 mySessionsHeader"> 
            My Sessions
        </div>
        <div>
            <v-row>
            ...
            <v-card class="my-15" max-width="">
                <div class="text-center">
                    <div v-if="isAdmin == true || isMentor == true" class="subcardHeader">
                        As Individual
                    </div>
            ...
            <v-card v-if="isMentor == true" class="my-15" max-width="">
                <div class="text-center">
            ...
            <v-card v-if="isAdmin == true" class="my-15" max-width="">
                <div class="text-center">
                    <div class="subcardHeader">
                        As Admin
                    </div>
